...
parse_record_test_data = [
    (['Potters Bar CC (H) - Welwyn Garden City CC (A)', '13/05/2026', 'WGCCC Juniors', 'Cheryl Worman', '12', ''],
     Fixture(CricketTeam.U13s, 'Potters Bar CC', Location.AWAY, FixtureType.LEAGUE, base_start_date_time, base_end_date_time, Ground.AWAY, base_result)),
    (['Welwyn Garden City CC (H) - Wheathampstead CC (A)', '13/05/2026', 'WGCCC Juniors', 'Bharat Ranavaya', '12', 'Digswell Park'],
     Fixture(CricketTeam.U9s, 'Wheathampstead CC', Location.HOME, FixtureType.LEAGUE, base_start_date_time, base_end_date_time, Ground.DP, base_result)),
]
