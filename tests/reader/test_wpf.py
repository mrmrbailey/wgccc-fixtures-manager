...
parse_record_test_data = [
    (['19/05/2026', 'WGCCC U10B', 'Letchworth Garden City CC - Under 10 B', 'Astro'],
     Fixture(CricketTeam.U10s, 'Letchworth Garden City CC - Under 10 B', Location.HOME, FixtureType.LEAGUE, base_start_date_time, base_end_date_time, Ground.WPF, base_result),),
]
